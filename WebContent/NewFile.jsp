...
<link rel="mask-icon" type="" href="/assets/img/imgHome/icoPistony.png" color="#111">
...
<body translate="no">
  ...
  <div class="glitch__item"></div>
  <div class="glitch__item"></div>
  <h5 class="glitch__title">Qualcosa &egrave; andato storto nel sito, sembra essersi verificato un errore
				<s:property value="exception" /></h5>
</div>
              </div>
        </div>
    </div>
