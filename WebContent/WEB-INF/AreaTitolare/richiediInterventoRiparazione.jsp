					...
					<div class="card mb-4">
						...
						<div class="card-body" style="text-align: center;">
							...
							<s:form method="post" theme="simple"
								action="AggiungiInterventoRiparazione">
								...
								<div class="form-group">
									...
									<s:textfield type="date" name="data" requiredLabel="true" />
								</div>

								<div class="form-group">
									<label>Tagliando:</label>
									<s:select name="tagliando" list="#{'Si':'Si', 'No':'No'}" />
								</div>

								<div class="form-group">
									<label>Tipo di riparazione:</label> <br>
									<textarea name="tipoRiparazione" rows="" cols=""></textarea>
								</div>
